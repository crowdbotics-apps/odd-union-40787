"""
Django settings for odd_union_40787 project.
...
ROOT_URLCONF = 'odd_union_40787.urls'
...
WSGI_APPLICATION = 'odd_union_40787.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_union_40787 API",
    "DESCRIPTION": "API documentation for odd_union_40787 App",
    "VERSION": "v1",
}
